...
const val DEFAULT_NOTIFY_TITLE = "키오스크관리"
const val DEFAULT_NOTIFY_TEXT = "원격 도움 준비됨"
...
class MainService : Service() {
    ...
    private val wakeLock: PowerManager.WakeLock by lazy { powerManager.newWakeLock(PowerManager.ACQUIRE_CAUSES_WAKEUP or PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "kioskmgr:wakelock")}
